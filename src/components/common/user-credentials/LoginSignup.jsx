...
const LoginSignup = () => {
  ...
  const main = useSelector((state) => state.lang.value.signUp.global);
  return (
              ...
              <div className="sign_up_form">
                ...
                <form action="#">
                  <div className="row ">
                    <div className="col-lg-12">
                      <button type="submit" className="btn btn-fb w-100">
                        <i className="fa fa-facebook float-start mt5"></i> {main.facebook[lang]}
                      </button>
                    </div>
                    <div className="col-lg-12">
                      <button type="submit" className="btn btn-googl w-100">
                        <i className="fa fa-google float-start mt5"></i> {main.gmail[lang]}
                      </button>
                    </div>
                  </div>
                  {/* End .row */}
                  ...
                  <div className="form-group input-group  mb-3">
                    <input
                      ...
                      placeholder={main.rePassword[lang]}
                    />
                    <div className="input-group-prepend">
                      <div className="input-group-text">
                        <i className="flaticon-password"></i>
