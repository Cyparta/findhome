...
const ListingGallery = () => {
  ...
  return (
    <>
      <Gallery>
        {propertiesContent.slice(0, 3).map((singleItem) => (
          <div key={singleItem.id}>
            <div className="row mb30">
              <div className="col-lg-7 col-xl-8">
                <div className="single_property_title mt30-767">
                  <h2>{singleItem.title[lang]}</h2>
                  <p>{singleItem.location[lang]}</p>
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div className="spls_style_two mb30-520">
                      <Item
                        original={singleItem.img[lang]}
                        thumbnail={singleItem.img[lang]}
                        width={752}
                        height={450}
                      >
                        {({ ref, open }) => (
