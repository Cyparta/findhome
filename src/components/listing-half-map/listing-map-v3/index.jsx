      ...
      <div className={lang}>
        ...
        >
          <div className="container-fluid">
            <div className="row check-desktop">
              ...
              <div className="col-xl-9 col-lg-12 col-md-12 order-lg-1 order-xl-2 p0 position-relative">
              ...
              <div className="col-xl-3 col-lg-12 col-md-12 order-lg-2 order-xl-1">
                <div className="half_map_area_content mt30">
                  <div className="col-md-12">
                    <div className="grid_list_search_result ">
                      <div className="row align-items-center topbar-2">
                        <FilterTopBar2 />
                      </div>
                    </div>
                    {/* End .row */}
