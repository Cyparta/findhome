...
import DetailsContent from "../../components/listing-details-v3/DetailsContent";
import Sidebar from "../../components/listing-details-v1/Sidebar";
import FeatureProperties from "../../components/common/listing/FeatureProperties";
import { decoration, realestateforrent } from "../../data/menuData";
    ...
    <>
      <div className={lang}>
        ...
        <section className="single_page_listing_style p0 mt85 md-mt0">
          <FeatureProperties id={id} typetofilter={decoration} />
        </section>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12 col-lg-12">
                <DetailsContent id={id} typetofilter={decoration} />
              </div>
            </div>
            {/* End .row */}
          </div>
